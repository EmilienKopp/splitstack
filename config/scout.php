...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | pg_textsearch Engine
    |--------------------------------------------------------------------------
    |
    | Configuration for the custom pg_textsearch Scout engine. The engine
    | queries the live table using the <@> BM25 operator — no external index
    | is required. Set the driver to "pg_textsearch" on models that use the
    | HasFullTextSearch trait, or override searchableUsing() directly.
    |
    */
