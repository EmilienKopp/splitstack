...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // });
    Route::middleware([HandlePrecognitiveRequests::class])->prefix('daily-logs')->group(function () {
        Route::post('/daily-logs/{daily_log}/clock-in', [DailyLogController::class, 'clockIn'])->name('daily-log.clock-in');
        Route::post('/daily-logs/{daily_log}/clock-out', [DailyLogController::class, 'clockOut'])->name('daily-log.clock-out');
        Route::post('/daily-logs/{daily_log}/punch', [DailyLogController::class, 'punch'])->name('daily-log.punch');
        Route::post('/daily-logs', [DailyLogController::class, 'store'])->name('daily-log.store');
    });
